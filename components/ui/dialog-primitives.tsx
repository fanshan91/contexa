...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "bg-overlay/40 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50",
        className
      )}
      {...props}
    />
...
function DialogContent({
  ...
  ...props
}: React.ComponentProps<typeof DialogPrimitive.Content> & { closeOnOverlayClick?: boolean }) {
  return (
    <DialogPortal>
      <DialogOverlay />
